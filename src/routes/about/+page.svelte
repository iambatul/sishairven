...
<div class="min-h-screen bg-black">
	...
	<section class="py-16">
		<div class="max-w-4xl mx-auto px-4">
			<div class="grid md:grid-cols-2 gap-12 items-center">
				<div>
					<h2 class="text-3xl font-display text-white mb-6">Our Story</h2>
					<div class="space-y-4 text-gray-light">
						<p>
				...
				<div class="bg-black-soft/50 p-8 rounded-lg border border-pink-bright/20">
					...
					<ul class="space-y-4 text-gray-light">
						<li class="flex items-start">
							<span class="text-pink-bright mr-3 text-xl">✓</span>
							<div>
								<strong class="text-white">Expert Stylists</strong>
								<p class="text-sm text-gray-medium mt-1">Our team is trained in the latest techniques including French Balayage.</p>
							</div>
						</li>
						<li class="flex items-start">
							<span class="text-pink-bright mr-3 text-xl">✓</span>
							<div>
								<strong class="text-white">Premium Products</strong>
								<p class="text-sm text-gray-medium mt-1">We use only the highest quality products from Moroccanoil, Kerastase, and more.</p>
							</div>
						</li>
						<li class="flex items-start">
							<span class="text-pink-bright mr-3 text-xl">✓</span>
							<div>
								<strong class="text-white">Personalized Service</strong>
								<p class="text-sm text-gray-medium mt-1">Every client receives a customized consultation and treatment plan.</p>
							</div>
						</li>
						<li class="flex items-start">
							<span class="text-pink-bright mr-3 text-xl">✓</span>
							<div>
								<strong class="text-white">Relaxing Atmosphere</strong>
								<p class="text-sm text-gray-medium mt-1">Our salon is designed to be your escape from the everyday.</p>
							</div>
						</li>
					</ul>
				</div>
	...
	<section class="py-16 bg-black-soft/30">
		<div class="max-w-4xl mx-auto px-4 text-center">
			<h2 class="text-3xl font-display text-white mb-8">Our Specialization</h2>
	...
	<section class="py-16">
		<div class="max-w-4xl mx-auto px-4 text-center">
			<h2 class="text-3xl font-display text-white mb-6">Visit Us Today</h2>
